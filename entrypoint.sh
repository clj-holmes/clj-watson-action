...
suggestion_fix="$8"
database_strategy="$9"
output_cmd="-M -m clj-watson.cli scan -p ${deps_edn_path}"
...
clojure -Sdeps "{:deps {io.github.clj-holmes/clj-watson {:git/tag \"${clj_watson_tag}\" :git/sha \"${clj_watson_sha}\"}}}" ${output_cmd[@]}
